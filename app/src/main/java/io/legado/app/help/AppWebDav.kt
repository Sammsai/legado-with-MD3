        ...
        syncMutex.withLock {
            kotlin.runCatching {
                ...
                if (remoteNeedsUpload || remoteBookshelfFile == null || remoteDeletedBooksFile == null || toDeleteLocally.isNotEmpty()) {
                    val finalBooks = appDb.bookDao.all
